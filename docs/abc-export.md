...
仅支持大调。多声部会导出为独立 `V:` 段落，但尚不处理 ABC `%%score` 分组或同谱表合并。ABC 导出支持 tie、slur、基础三连音、反复、ending 和反复导航装饰；播放层会展开简单反复、一二房子以及常见 D.C./D.S. 到 Fine/Coda，但导出器本身不改写乐谱结构。跨小节的独立 `-` extension、通用比例连音、装饰音、和弦及复杂跨声部连线尚未支持。新增规则必须同时增加 golden 或单元测试。
