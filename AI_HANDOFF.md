...
- Browser validation UI with a single jianpu/staff preview switch, preset/custom jianpu line spacing, optional one-measure full-score count-in, separate playback/editor-caret highlighting, right-click JABC token navigation, SVG/PNG score downloads, instrument selection, and copy/download actions for ABC and MusicXML.
