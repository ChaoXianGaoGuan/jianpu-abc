...
measure columns, measure wrapping, readable narrow-screen spacing with responsive SVG scaling when needed, multi-voice labels, and optional event highlighting. The
