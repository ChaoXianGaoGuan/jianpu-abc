...
measure columns, measure wrapping, readable narrow-screen spacing with horizontal overflow when needed, multi-voice labels, and optional event highlighting. The
